...
/// jellyfin-plugin-mdblist's ItemKeys.cs (itself library_snapshot.py's
/// PROVIDER_PRIORITY-ordered canonical_movie_key/canonical_episode_key/
/// find_movie_match/find_episode_match). An item carrying more than one
/// provider id is matched on whichever one this order finds first, tolerant
/// of a remote entry using a different id than the local item's preferred one.
/// </summary>
