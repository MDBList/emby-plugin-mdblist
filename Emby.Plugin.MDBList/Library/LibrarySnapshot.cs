...
/// jellyfin-plugin-mdblist's LibrarySnapshot.cs (itself
/// library_snapshot.py's build_snapshot()). Read-only: builds no writes,
/// only a snapshot to match remote sync state against.
///
/// Unlike the Jellyfin sibling, <c>InternalItemsQuery.IncludeItemTypes</c>
/// takes plain type-name strings ("Movie"/"Episode") here, not a
/// <c>BaseItemKind</c> enum array -- confirmed by reflection.
/// </summary>
public class LibrarySnapshot
{
    ...
    /// <summary>
    /// Builds a snapshot of one Emby user's movie and episode library.
    /// </summary>
    /// <param name="libraryManager">Instance of the <see cref="ILibraryManager"/> interface.</param>
    /// <param name="userDataManager">Instance of the <see cref="IUserDataManager"/> interface.</param>
    /// <param name="user">The Emby user whose watched/rating state to read.</param>
    ...
    public SnapshotItem? FindMovie(MediaIds ids)
    {
